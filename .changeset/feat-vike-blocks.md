...
New `vike-blocks` package: the framework-agnostic substrate for composable UI as data, split out of vike-view so it's usable standalone and third parties can add elements with high DX.
