...
//
// Two more contribution points enable the ZERO-CONFIG `lang: [...]` auto-include
...
//   - `lang`        : the app's languages (e.g. ['en','fr','ar']). A single value
//                     the app sets; the Vite plugin reads it.
...
//                     (vike-i18n/plugin) turns `lang` + this registry into a virtual
...
export default {
  ...
  meta: {
    ...
    lang: { env: { config: true, server: true, client: true } },
